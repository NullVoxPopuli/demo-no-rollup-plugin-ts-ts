...
class Addon {
    ...
    // does that.
    clean() {
        return (0, rollup_plugin_delete_1.default)({ targets: `${__classPrivateFieldGet(this, _Addon_destDir, "f")}/*`, hook: 'generateBundle' });
    }
    ...
    output() {
        return {
            dir: __classPrivateFieldGet(this, _Addon_destDir, "f"),
            format: 'es',
            entryFileNames: '[name]',
